...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[5] = LAYOUT(KC_P7, KC_P8, KC_P9, KC_PSCR, KC_CAPS, KC_PAUS, KC_BTN1, KC_BTN1, KC_BTN2, KC_BTN3, KC_WH_D, KC_WH_U, KC_P4, KC_P5, KC_P6, KC_INS, KC_HOME, KC_PGUP, KC_MUTE, KC_VOLD, KC_VOLU, KC_MRWD, KC_MFFD, KC_MPLY, KC_P1, KC_P2, KC_P3, KC_DEL, KC_END, KC_PGDN, KC_HOME, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_END, KC_LCTL, KC_P0, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_LOCK, OSL(6), KC_APP, KC_INS, KC_PGDN, KC_PGUP, KC_EQL, KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, TG(3), KC_TRNS, KC_TRNS, KC_ENT, KC_TRNS),
