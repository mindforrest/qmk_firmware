...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_TAB, KC_LCTL, KC_W, KC_F, KC_P, KC_COMM, KC_DOT, KC_L, KC_U, KC_Y, KC_SCLN, KC_MINS, KC_LSFT, KC_A, KC_R, KC_S, KC_T, KC_G, KC_K, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_Q, KC_Z, KC_X, KC_C, KC_D, KC_B, KC_LBRC, KC_RBRC, KC_M, KC_H, KC_V, KC_J, KC_SLSH, KC_EXLM, KC_LALT, KC_LGUI, MO(5), KC_SPC, LT(6,KC_ENT), KC_BSPC, KC_RSFT, KC_DEL),
