...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[1] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_MINS, KC_LSFT, KC_A, KC_R, KC_S, KC_T, KC_D, KC_H, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_LCTL, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_LBRC, KC_RBRC, KC_K, KC_M, KC_DOT, KC_SLSH, KC_RSFT, KC_EXLM, KC_LALT, KC_LGUI, MO(5), KC_SPC, LT(6,KC_ENT), KC_BSPC, KC_COMM, KC_DEL),

	[2] = LAYOUT(KC_ESC, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_GRV, KC_TAB, KC_LCTL, KC_W, KC_F, KC_P, KC_COMM, KC_DOT, KC_L, KC_U, KC_Y, KC_SCLN, KC_MINS, KC_LSFT, KC_A, KC_R, KC_S, KC_T, KC_G, KC_K, KC_N, KC_E, KC_I, KC_O, KC_QUOT, KC_Z, KC_Q, KC_X, KC_C, KC_D, KC_B, KC_LBRC, KC_RBRC, KC_M, KC_H, KC_J, KC_V, KC_SLSH, KC_EXLM, KC_LALT, KC_LGUI, MO(5), KC_SPC, LT(6,KC_ENT), KC_BSPC, KC_RSFT, KC_DEL),
	...
	[5] = LAYOUT(KC_PWR, KC_SLEP, KC_WAKE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_TRNS, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_F13, KC_F14, KC_F15, KC_F16, KC_F17, KC_F18, KC_F19, KC_F20, KC_F21, KC_F22, KC_F23, KC_F24, KC_LCTL, KC_UNDO, KC_CUT, KC_COPY, KC_PSTE, KC_AGIN, DF(0), DF(1), KC_APP, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_PIPE, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, TG(3), DF(2), KC_TRNS, KC_TRNS),

	[6] = LAYOUT(KC_P7, KC_P8, KC_P9, KC_PSCR, KC_CAPS, KC_PAUS, KC_BTN1, KC_BTN1, KC_BTN2, KC_BTN3, KC_WH_D, KC_WH_U, KC_P4, KC_P5, KC_P6, KC_INS, KC_HOME, KC_PGUP, KC_MUTE, KC_VOLD, KC_VOLU, KC_MRWD, KC_MFFD, KC_MPLY, KC_P1, KC_P2, KC_P3, KC_DEL, KC_END, KC_PGDN, KC_HOME, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, KC_END, KC_LCTL, KC_P0, KC_PSLS, KC_PAST, KC_PMNS, KC_PPLS, KC_LOCK, OSL(7), KC_APP, KC_INS, KC_PGDN, KC_PGUP, KC_EQL, KC_BSLS, KC_TRNS, KC_TRNS, KC_TRNS, TG(3), KC_TRNS, KC_TRNS, KC_ENT, KC_TRNS),
